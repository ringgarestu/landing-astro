...
export default function ModalPrivacyPolicy() {
  ...
  return (
    <>
      <span className="text-base" onClick={onOpen} style={{ cursor: "pointer" }}>
        Privacy Policy
      </span>
      <Modal isOpen={isOpen} onOpenChange={onOpenChange} scrollBehavior={scrollBehavior}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Privacy Policy</ModalHeader>
              <ModalBody>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      <strong>Application</strong> refers to PestDoc-AI, the software program provided by the Company.
                    </p>
                  </li>
                  <li>
                    <p>
                      <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PT. Putri Dewisri Mandiri, Gedung Graha Selaras, Jl. Asia Afrika No.129
                      Lantai 5, Jawa Barat 40112, Indonesia.
                    </p>
                  </li>
                  <li>
                    <p>
                ...
                <ul>
                  <li>By email: apps@pestdoc-ai.com</li>
                </ul>
              </ModalBody>
              <ModalFooter>
